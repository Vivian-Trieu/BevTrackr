...
function updatePingStatus() {
    ...
    if (selectedHole !== "") {
        ...
        firebase.database().ref('ElPradoButterfieldStageCartMaint/' + 'hole' + selectedHole).update({
            ping: true
        }).then(function () {
...
firebase.database().ref('ElPradoButterfieldStageCartMaint').on('value', function (snapshot) {
